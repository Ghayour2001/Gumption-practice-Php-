...
<body>
                ...
                <form id="student-form" method="post" action="insert.php" enctype="multipart/form-data">
                    ...
                    <div class="main2 col-md-12 mt-3 mb-5 border border-info">
                        ...
                        <input type="hidden" id="subjectId" name="subjectId"> <!-- Hidden field to store subject ID -->
                            ...
                            <div class="col-sm-2">
                            <button type="button" id="addButton" onclick="insertsubject()" class="btn btn-primary">Add</button>
                            </div>
                        </div>
    ...
    <script>
        ...
        function insertsubject() 
        {
            ...
            {
                alert('Please fill  subjectName and marks.');
            }
        }
...
//"Edit" button 
function editSubject(subjectId, subjectName, marks) 
{
    $("#subjectId").val(subjectId);
    $("#subjectName").val(subjectName);
    $("#marks").val(marks);
    $("#addButton").text("Update").attr("onclick", "updateSubject()");
}
    ...
    if (subjectName !== '' && marks !== '') 
    {
        ...
        $.ajax({
            ...
            success: function(response) 
            {
                ...
                $("#subjectName").val('');
                $("#marks").val('');
                $("#addButton").text("Add").attr("onclick", "insertsubject()");
                refreshSubjectTable();
            },
            error: function(error) 
            {
